...
|--------------|---------------------|----------------------|
| Jump Box     | No                  | 52.186.149.216       |
| Web1-DVWA    | No                  | 10.0.0.7             |
| Web2-DVWA    | No                  | 10.0.0.8             |
| ELK Server   | No                  | 40.83.40.50          |
| Load Balancer| No                  | 52.142.57.13         |
​
### Elk Configuration
​
...
cd /etc/ansible curl -i href="https://github.com/Isaiahama/Goodman" ansible-playbook /etc/ansible/elk.yml
